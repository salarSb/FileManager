...
<head>
  ...
  <title>دایرکتوری جدید · {{ @TITLE }}</title>
...
<body>
  ...
  <main class="container" style="margin-top: 100px">
    <h1 class="font-weight-bold"><i class="fa fa-plus"></i> دایرکتوری جدید در <span dir="ltr"><?php echo '/' . trim($path, '/'); ?></span></h1>
    <form method="post">
      <div class="form-group">
        <label for="name">نام دایرکتوری</label>
        <input type="text" dir="ltr" class="form-control" name="name" id="name" placeholder="نام دایرکتوری" required autofocus>
      </div>
