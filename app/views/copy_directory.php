...
<head>
  ...
  <title>کپی دایرکتوری · {{ @TITLE }}</title>
...
<body>
  ...
  <main class="container" style="margin-top: 100px">
    <h1 class="font-weight-bold"><i class="fa fa-copy"></i> کپی دایرکتوری <span dir="ltr"><?php echo $_GET['path']; ?></span></h1>
    <form method="post">
      <div class="form-group">
        <label for="destination">مقصد</label>
        <input type="text" dir="ltr" class="form-control" name="destination" id="destination" placeholder="مقصد" required autofocus value="<?php echo $_GET['path']; ?>">
      </div>
      <input type="submit" class="btn btn-dark" value="کپی">
    </form>
  </main>
